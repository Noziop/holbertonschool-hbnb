...
ns = Namespace('users', validate=True, description='Where lost souls come to REST! 👻', path='api/v1/users')
facade = HBnBFacade()
...
user_model = ns.model('User', {
    'id': fields.String(readonly=True, description='Spectral identifier', example='123e4567-e89b-12d3-a456-426614174000'),
    'username': fields.String(required=True, description='Ghost name', example='Casper'),
    'email': fields.String(required=True, description='Spirit contact', example='caspe@lost-souls.ghost'),
    'password': fields.String(required=True, description='Supernatural secret', example='IcyD34dPe0p!e'),
    'first_name': fields.String(required=True ,description='First haunting name', example='Casper'),
    'last_name': fields.String(required=True ,description='Last haunting name', example='The Friendly_Ghost'),
    'phone_number': fields.String(description='Ghostly phone', example='+666666666'),
    'address': fields.String(description='Haunting address', example='123 Ghostly Lane'),
    ...
    'country': fields.String(description='Realm of existence', example='Ghostly Realm'),
    'is_active': fields.Boolean(required=True,description='Is the ghost active?', default=True)
})

# Book of Shadows 📖 The spirits that haunt us! but we won't reveal your secrets !
output_user_model = ns.model('User_output', {
    'id': fields.String(readonly=True, description='Spectral identifier', example='123e4567-e89b-12d3-a456-426614174000'),
    'username': fields.String(required=True, description='Ghost name', example='Casper'),
    'email': fields.String(required=True, description='Spirit contact', example='casper@lost-souls.ghost'),
    'first_name': fields.String(required=True, description='First haunting name', example='Casper'),
    'last_name': fields.String(required=True, description='Last haunting name', example='The Friendly_Ghost'),
    'phone_number': fields.String(description='Ghostly phone', example='+666666666'),
    'address': fields.String(description='Haunting address', example='123 Ghostly Lane'),
    ...
    'is_admin': fields.Boolean(required=True, readonly=True, description='Is the ghost an admin?', default=False),
})
