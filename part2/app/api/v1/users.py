...
user_model = ns.model(
    "User",
    {
        ...
        "password": fields.String(
            required=True, description="Supernatural secret", example="IcyD34dPe0p!e"
        ),
...
class UserList(Resource):
    ...
    @ns.doc(
        "list_users",
        responses={200: "Success", 400: "Invalid parameters", 404: "No users found"},
    )
...
class UserDetail(Resource):
    ...
    @ns.doc(
        "update_user",
        responses={200: "Success", 400: "Invalid parameters", 404: "User not found"},
    )
    @ns.expect(user_model)
    @ns.marshal_with(output_user_model, code=200)
