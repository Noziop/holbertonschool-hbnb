...
def test_amenity_creation():
    ...
    amenity = Amenity(name="Spirit Box", description="Communicate with spirits!")
...
def test_amenity_update(test_amenity):
    ...
    test_amenity.update({"name": "EMF Reader", "description": "Updated description"})

    assert test_amenity.name == "EMF Reader"
    assert test_amenity.description == "Updated description"

    # Test duplicate name
    other_amenity = test_amenity.__class__(name="Other Amenity", description="Test")
    other_amenity.save()
